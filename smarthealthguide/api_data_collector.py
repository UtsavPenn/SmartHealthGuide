...
def get_place_details(textquery):
    ...
    url = "https://maps.googleapis.com/maps/api/place/textsearch/json?key=AIzaSyD-3egv6QjDN_H-oGpqqCs7aMaCDf1OuB8&location=38.904513,-77.197910&radius=500&query={}".format(textquery)
